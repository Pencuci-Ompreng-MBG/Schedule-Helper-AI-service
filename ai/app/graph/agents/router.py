...
5. "raw_time" MUST capture the time phrase AND its context based on the user's sentence. 
   -> IMPORTANT FOR INDONESIAN SLANG: Pay very close attention to the word "set" or "setengah" (e.g., "set 8" or "setengah 8" means 07:30, NOT 08:00). You MUST accurately capture this in the extraction.
   -> Add the context in parentheses. Examples: "besok jam 9 (deadline)", "besok jam set 8 / 07:30 (waktu ujian)". If no time is mentioned, output null.
